  ...
  <label :class="styles.field" :for="resolvedId">
    ...
    <div :class="styles.controlWrap">
      ...
      <span v-if="hasAppend" :class="styles.append">
        ...
        >
          <svg v-if="!isPasswordVisible" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
          ...
          <svg v-else viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
            ...
            <path d="M6.7 6.7A14.9 14.9 0 0 0 2 12s3.5 6 10 6c2.2 0 4-.6 5.6-1.5" stroke-width="1.8" />
...
const INPUT_PRESETS: Record<UiInputPreset, { type: string; autocomplete: string; inputmode?: string }> = {
...
const resolvedAutocomplete = computed(() => props.autocomplete || INPUT_PRESETS[props.preset].autocomplete)
const resolvedInputmode = computed(() => props.inputmode || INPUT_PRESETS[props.preset].inputmode || undefined)
